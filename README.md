...
```
wget -O - https://raw.githubusercontent.com/atom-sw/mrracket/master/install.sh | bash -l
```
...
```
wget -O - https://raw.githubusercontent.com/atom-sw/mrracket/master/install.sh | bash -l -s -- -o
```
